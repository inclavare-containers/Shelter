/*
 * This is an example implementing shelter interfaces 
 * similar to chroot with libkrun.
 *
 * It can execute the requested command (relative to NEWROOT) 
 * and shelter tools inside a fresh
